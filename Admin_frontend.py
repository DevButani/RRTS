...
def check_resources_page(window):
    ...
    Label(display_frame,text="Resource Utilisation  Information ",font=('Courier New Greek',22,'underline','bold')).grid(row=0,column=0,columnspan=2,pady=(0,10))
    ...
    resource_list_entry[0].grid(row=0,column=0)
    ...
    type_list_entry[0].grid(row=0,column=1)
    ...
    num_available_entry[0].grid(row=0,column=2)
    ...
    num_in_use_entry[0].grid(row=0,column=3)
    for i in display_df.index:
        ...
        resource_list_entry[i+1].grid(row=i+1,column=0)
        ...
        type_list_entry[i+1].grid(row=i+1,column=1)
        ...
        num_available_entry[i+1].grid(row=i+1,column=2)
        ...
        num_in_use_entry[i+1].grid(row=i+1,column=3)
    display_frame.pack()
    page_frame.pack()
