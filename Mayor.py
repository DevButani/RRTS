...
def mayor_page(window):
    ...
    logout_button1=Button(header1, text="Logout  ", image=logout_pic, bg="#5cdb95", fg="#05386b", font=("yu gothic ui", 15), borderwidth=0, highlightthickness=0, activebackground="#5cdb95", activeforeground="#05386b", cursor="hand2", compound="right")
    ...
    stat103=Label(report1, bg="#05386b", fg="white", text="(Dates in DD-MM-YYYY format)", font=("yu gothic ui", 15))
    ...
    locality_variable1.set(locality_options[0])
    locality_menu1 = OptionMenu(report1, locality_variable1, *locality_options)
    ...
    problem_options=["Pothole", "Broken Footpath", "Cracks", "Waterlogging", "Ravelling", "Road rutting", "Uneven"]
    problem_variable1 = StringVar()
    problem_variable1.set(problem_options[0])
    problem_menu1 = OptionMenu(report1, problem_variable1, *problem_options)
    ...
    problem_menu1.place(x=report1.winfo_screenwidth()*0.325, y=report1.winfo_screenheight()*0.125, width=int(report1.winfo_screenwidth()*0.1), height=35)
    ...
    stat203=Label(report2, bg="#05386b", fg="white", text="(Dates in DD-MM-YYYY format)", font=("yu gothic ui", 15))
    ...
    resource_type_variable1.set(resource_type_options[0])
    resource_type_menu1 = OptionMenu(report2, resource_type_variable1, *resource_type_options)
    ...
    ####dynamically change lists
    resource_name_options=["Pothole", "Broken Footpath", "Cracks", "Waterlogging", "Ravelling", "Road rutting", "Uneven"]
    resource_name_variable1 = StringVar()
    resource_name_variable1.set(resource_name_options[0])
    resource_name_menu1 = OptionMenu(report2, resource_name_variable1, *resource_name_options)
    ...
    resource_name_menu1.place(x=report2.winfo_screenwidth()*0.35, y=report2.winfo_screenheight()*0.125, width=int(report2.winfo_screenwidth()*0.1), height=35)
